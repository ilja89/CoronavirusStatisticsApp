...
DataUpdate:     setProgress(60)
    ...
    Private Sub InitMap()
        ...
        MapControl1.AddPolygon(stringToPoints("
            ...
            False)
        ' RAW! Rework!
        MapControl1.AddPolygon(stringToPoints("615,635,631,637,663,625,568,610,677,625,671,608,671,593,693,599,695,580,
            693,565,710,562,739,554,736,537,721,524,724,502,730,489,736,466,734,438,727,419,719,389,728,356,734,337,728,
            320,705,307,689,307,675,305,653,292,633,277,621,264,601,255,573,256,562,273,571,300,570,315,568,329,551,341,
            536,361,508,358,488,361,470,356,455,352,452,371,467,380,486,389,505,384,524,382,542,376,538,410,538,429,551,
            451,560,476,560,490,539,490,548,507,571,530,565,556,568,573,562,586,586,629
        ...
        "), "Pärnumaa", "Pärnu maakond",
            ...
            True)
        MapControl1.AddPolygon(stringToPoints("
            1169,944,1150,944,1128,934,1141,921,1127,919,1110,912,1097,904,1088,891,1073,887,1073,910,1070,923,1059,904,
            1054,891,1041,885,1027,885,1000,897,1000,876,1014,863,1014,863,1023,842,1039,820,1062,820,1059,799,1059,784,
            1036,769,1017,758,992,756,983,743,985,717,989,681,1003,650,1027,623,1048,607,1059,580,1076,597,1106,601,1122,
            595,1144,590,1159,577,1180,569,1195,556,1210,560,1210,575,1212,588,1224,601,1240,599,1257,605,1278,625,1286,650,
            1311,659,1319,676,1319,700,1293,691,1273,696,1273,710,1264,726,1257,754,1260,769,1269,786,1273,801,1279,818,1286,833,
            1292,854,1273,861,1252,842,1239,841,1234,863,1230,876,1213,884,1201,904,1183,904,1171,917
        ...
        "), "Valgamaa", "Valga maakond",
            ...
            True)
        MapControl1.AddPolygon(stringToPoints("
            1500,949,1479,955,1456,944,1455,925,1458,
            910,1452,887,1458,872,1476,833,1476,833,1492,816,1508,816,1535,809,1539,790,1554,
            779,1570,790,1586,792,1591,768,1603,781,1616,769,1633,769,1656,773,1671,786,1684,792,
            1709,784,1719,814,1727,842,1742,863,1752,889,1761,906,1778,912,1780,934,1807,964,1823,
            970,1816,992,1802,994,1766,998,1749,1000,1712,1000,1696,1000,1683,1000,1675,983,1689,977,
            1678,964,1660,966,1625,953,1618,934,1601,938,1600,957,1586,960,1570,944,1559,957,1544,957,1527,957
        ...
        "), "Jõgevamaa", "Jõgeva maakond",
            ...
            True)
        MapControl1.AddPolygon(stringToPoints("
            1165,264,1121,219,1125,238,1128,256,1116,273,1116,301,1115,320,1100,324,1094,361,1077,371,1073,397,1070,419,1054,431,1056,
            447,1060,461,1144,590,1144,590,1180,569,1195,556,1210,560,1216,537,1231,519,1249,502,1260,517,1267,498,1267,498,1292,466,1319,457,
            1319,438,1320,397,1308,374,1286,359,1286,346,1264,343,1246,344,1246,307,1254,290,1264,273,1245,262,1224,262,1195,256
